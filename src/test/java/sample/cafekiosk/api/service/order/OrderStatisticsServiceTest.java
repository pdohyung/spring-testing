...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        //given
        LocalDateTime now = LocalDateTime.of(2024, 2, 2, 0, 0);
        ...
        Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2024, 2, 1, 23, 59, 59), products);
        Order order2 = createPaymentCompletedOrder(now, products);
        Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2024, 2, 2, 23, 59, 59), products);
        Order order4 = createPaymentCompletedOrder(LocalDateTime.of(2024, 2, 3, 0, 0), products);
        ...
        //when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2024, 2, 2), "test@test.com");
